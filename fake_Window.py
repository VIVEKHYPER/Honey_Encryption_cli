...
class Ui_FakeWindow(object):
    def setupUi(self, FakeWindow):
        ...
        self.menubar = QtGui.QMenuBar(FakeWindow)
    ...
    def retranslateUi(self, FakeWindow):
        FakeWindow.setWindowTitle(_translate("Honey Encryption", "Main Window", None))
        ...
        self.menuFile.setTitle(_translate("FakeWindow", "File", None))
        self.menuGroups.setTitle(_translate("FakeWindow", "Groups", None))
        self.menuHelp.setTitle(_translate("FakeWindow", "Help", None))
        self.menuEntry.setTitle(_translate("FakeWindow", "Entry", None))
        self.actionNew_Database.setText(_translate("FakeWindow", "New Database", None))
        self.actionOpen_Database.setText(_translate("FakeWindow", "Open Database", None))
        self.actionNew_Group.setText(_translate("FakeWindow", "New Group", None))
        self.actionEdit_Group.setText(_translate("FakeWindow", "Edit Group", None))
        self.actionDelete_Group.setText(_translate("FakeWindow", "Delete Group", None))
        self.actionAbout.setText(_translate("FakeWindow", "About", None))
        self.actionNew_Entry.setText(_translate("FakeWindow", "New Entry", None))
        self.actionDelete_Entry.setText(_translate("FakeWindow", "Delete Entry", None))
