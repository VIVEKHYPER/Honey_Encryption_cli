...
from main import delete_fake_db
...
class Ui_FakeWindow(object):
    def setupUi(self, FakeWindow):
        FakeWindow.setObjectName(_fromUtf8("FakeWindow"))
        FakeWindow.resize(790, 686)
        self.centralwidget = QtGui.QWidget(FakeWindow)
        ...
        self.db.setDatabaseName('fake.db')
        ...
        FakeWindow.setCentralWidget(self.centralwidget)
        self.statusbar = QtGui.QStatusBar(FakeWindow)
        self.statusbar.setObjectName(_fromUtf8("statusbar"))
        FakeWindow.setStatusBar(self.statusbar)
        self.retranslateUi(FakeWindow)
        QtCore.QMetaObject.connectSlotsByName(FakeWindow)

    def retranslateUi(self, FakeWindow):
        FakeWindow.setWindowTitle(_translate("Honey Encryption", "Honey Encryption", None))
        self.label.setText(_translate("FakeWindow",
        ...
        self.label_2.setText(_translate("MainWindow",
                                        ...
                                        None))
        self.comboBox.setItemText(0, _translate("FakeWindow", "Internet", None))
        self.comboBox.setItemText(1, _translate("FakeWindow", "Emails", None))
        self.comboBox.setItemText(2, _translate("FakeWindow", "PINS", None))
        self.comboBox.setItemText(3, _translate("FakeWindow", "Others", None))
        self.newRow_button.setText(_translate("FakeWindow", "New Row", None))
        self.deleteRow_button.setText(_translate("FakeWindow", "Delete Row", None))
